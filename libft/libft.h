...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/15 13:24:37 by duccello          #+#    #+#             */
/*   Updated: 2025/05/15 13:30:19 by duccello         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*free_strjoin(char *buffer, char *stash);
int					ft_printf(const char *smth, ...);
int					ft_printuns(unsigned int n);
int					ft_printstring(char *str);
int					ft_printnum(int n);
int					ft_printbigx(unsigned int n);
